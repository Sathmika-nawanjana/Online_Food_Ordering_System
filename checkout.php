...
if(isset($_POST['submit'])){
   ...
   if($check_cart->rowCount() > 0){
      ...
      if($address == ''){
         ...
         $message[] = 'order placed successfully! go to the Orders page see of the orders!';
      }
...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      ?>
      <p><span class="name"><?= $fetch_cart['name']; ?></span><span class="price">R.S. <?= $fetch_cart['price']; ?> x <?= $fetch_cart['quantity']; ?></span></p>
      <?php
            }
         }else{
      ...
      ?>
      <p class="grand-total"><span class="name">grand total :</span><span class="price">R.S. <?= $grand_total; ?>.00/=</span></p>
